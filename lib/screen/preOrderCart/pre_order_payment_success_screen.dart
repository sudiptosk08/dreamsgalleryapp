...
class PreOrderPaymentSuccessScreen extends StatefulWidget {
  @override
  _PreOrderPaymentSuccessScreenState createState() => _PreOrderPaymentSuccessScreenState();
}

class _PreOrderPaymentSuccessScreenState extends State<PreOrderPaymentSuccessScreen> {
  void initState() {
    _getAllOrder();
    super.initState();
  }
  ...
  Future<void> _getAllOrder() async {
    ...
    setState(() {
      ...
      List.generate(
          store.state.preOrderDataState.length, (index) => indexId = index);
    });
    setState(() {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.all(5.0),
              child: Text(
                "Your order No - PX${store.state.preOrderDataState[indexId]['id']}",
