...
class SSl extends StatefulWidget {
  @override
  SSlState createState() => SSlState();
}

class SSlState extends State<SSl> {
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: TextFormField(
                      initialValue: "dream5ecf34aa69953",
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: TextFormField(
                      initialValue: "dream5ecf34aa69953@ssl",
                      keyboardType: TextInputType.text,
                      decoration: InputDecoration(
                        border: OutlineInputBorder(
                            borderRadius:
